...
async function tebakgambar(req, res) {
    ...
    readFileJson('./lib/data/tebakgambar.json').then(result => {
        res.status(200).send({
            status: 200, 
            img: result.img, 
...
async function pemandangananimv1(req, res) {
    const apikey = req.query.apikey;
    if (apikey === undefined) return res.status(404).send({
        status: 404,
        message: `Input Parameter apikey`
    ...
    readFileJson('./lib/data/pemandangananimv1.json').then(result => {
        res.status(200).send({
            status: 200, 
            img: result.url
        });
...
async function pemandangananimv2(req, res) {
    const apikey = req.query.apikey;
    if (apikey === undefined) return res.status(404).send({
        status: 404,
        message: `Input Parameter apikey`
    ...
    readFileJson('./lib/data/pemandangananimv2.json').then(result => {
        res.status(200).send({
            status: 200, 
            img: result.url
        });
...
module.exports = {cakLontong, quotes, bijak, fakta, ptl, motivasi, tebakgambar, pemandangananimv1, pemandangananimv2 };
